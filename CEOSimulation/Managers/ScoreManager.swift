...
class ScoreManager {
    ...
    func recordDecision(_ decision: DecisionOption, for company: Company) {
    ...
    func calculateScore(for company: Company) -> Int {
    ...
    func getPerformanceAnalysis(for company: Company) -> PerformanceAnalysis {
    ...
    func getDecisionHistory() -> [ScoredDecision] {
        return decisionHistory
    }
    
    func getTopPerformingDecisions() -> [ScoredDecision] {
        return decisionHistory
 ...
 struct ScoredDecision {
     ...
     let quarterMade: Int
     let companyStateBefore: CompanySnapshot
     let timestamp: Date
    
     init(decision: DecisionOption, quarterMade: Int, companyStateBefore: CompanySnapshot, timestamp: Date) {
 ...
 struct CompanySnapshot {
     ...
     let departmentPerformances: [DepartmentType: Double]
 ...
 struct PerformanceMetrics {
     var totalBudgetSpent: Double = 0
     var averagePerformance: Double = 50
     var averageMorale: Double = 50
     var currentReputation: Double = 50
 ...
 struct PerformanceAnalysis {
     ...
     let averageDecisionCost: Double
     let strongestDepartment: DepartmentType
     let weakestDepartment: DepartmentType
     let keyStrengths: [String]
     let areasForImprovement: [String]
     let leadershipStyle: LeadershipStyle
 ...
 enum LeadershipStyle: String, CaseIterable {
